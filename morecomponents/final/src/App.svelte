<script>
  ...
  $: button1OtherType = button1Type === 'important' ? 'default' : 'important';
  let button1Clicks = 0;
...
<main>
  <div class="container">
    ...
    <div class="flex">
      ...
      <TippyUse text="Toggle the 'important' type for the first button">
        <Button
          selected={button1Type === 'important'}
          on:click={() => {
            button1Type = button1OtherType;
          }}>Change Button 1 type to "{button1OtherType}"</Button
        >
      </TippyUse>
